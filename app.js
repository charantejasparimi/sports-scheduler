...
const app = express();
const { sports, matches, sessions, player:playerModel, admin: adminModel} = require("./models");
  ...
  try {
    ...
    if (i !== -1) {
      ...
      if (matchRecords && matchRecords.length > 0) {
        ...
        console.log(`Reason for ${deleteMatches[i]} updated successfully in sessions.`);
      }
      else {
